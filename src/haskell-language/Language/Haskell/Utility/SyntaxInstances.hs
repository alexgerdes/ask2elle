...
instance BiplateFor Module
instance BiplateFor Decl
instance BiplateFor Rhs
instance BiplateFor Pat
instance BiplateFor Expr
instance BiplateFor GuardedExpr
